class VersionDiffer
  ...
  def released_versions
    ...
    versions = MultiJson.decode(open("https://rubygems.org/api/v1/versions/sportngin-watir-webdriver.json").read)
  ...
  def diff(old_version, new_version)
    ...
    left = "sportngin-watir-webdriver-#{old_version}.gem"
    right = new_version == "." ? new_version : "sportngin-watir-webdriver-#{new_version}.gem"
